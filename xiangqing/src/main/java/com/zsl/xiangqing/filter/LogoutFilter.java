package com.zsl.xiangqing.filter;
        ...
        try {
            ...
            try {
                ...
                if (StringUtils.isNotNull(user)) {
                    ...
                    // 记录用户退出日志
                    AsyncManager.me().execute(AsyncFactory.recordLoginInformation(loginName, Constants.LOGOUT, MessageUtils.message("user.logout.success")));
                    // 清理缓存
