...
public class UserDaoImpl extends GenericDaoImpl implements UserDao{
	...
	public int checkUsername(String userName) {
		return this.selectOne("UserMapper.checkUsername", userName);
	}
	...
	public void updateUserAll(User user){
		this.update("UserMapper.updateUserAll", user);
	}
	...
	@Override
	public int checkLoginAccount(String loginAccountPrefix) {
		return this.selectOne("UserMapper.checkLoginAccount", loginAccountPrefix);
	}

	@Override
	public List<User> queryUserList(QueryUser query) {
		return this.selectList("UserMapper.queryUserList",query);
	}
}
