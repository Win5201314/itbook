					...
					if(paperRecordList!=null&&paperRecordList.lenght!=0){
						...
						for(var i=0;i<paperRecordList.length;i++){
							...
							if(paperRecordNow.status==1){
								str+='<dd><a class="m-c-go fr" title="继续考试" href="/paper/toExamPaperRecord/'+paperRecordNow.id+'">继续考试</a>';
							}else{
								str+='<dd><a class="m-c-go fr" title="查看报告" href="/paper/toExamPaperRecord/'+paperRecordNow.id+'">查看报告</a>';
							}
