...
<div style="position: absolute; overflow: hidden; z-index: 1010; outline: 0px none; height: auto; width: 500px; top: 0px; left: 50%;margin-left: -250px;"
	...
	<div class="ui-dialog-buttonpane ui-widget-content ui-helper-clearfix tac">
		<button id="affirmBut" type="button" class="layui-btn layui-btn-small">确定</button>
		<button id="cancelBut" type="button" class="layui-btn layui-btn-small">取消</button>
	</div>
</div>