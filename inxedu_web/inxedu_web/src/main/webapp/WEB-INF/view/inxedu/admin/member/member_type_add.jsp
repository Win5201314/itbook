...
<fieldset class="layui-elem-field">
    ...
    <div class="layui-field-box">
        <div class="numb-box">
            <form class="layui-form" action="${ctx}/admin/membertype/add" method="post" id="addForm">
                <input type="hidden" name="memberType.imageUrl" value=""/>
                <div class="layui-form-item">
                    <label class="layui-form-label layui-form-label-w">名称</label>
                    <div class="layui-input-block">
                        <input type="text" name="memberType.title" id="title" lay-verify="required" placeholder="请输入名称" autocomplete="off" class="layui-input layui-input-6">
                    </div>
                </div>
                <div class="layui-form-item">
