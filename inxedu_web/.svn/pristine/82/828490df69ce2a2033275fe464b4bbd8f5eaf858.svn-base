...
public class SysRoleController extends BaseController {
	...
	@ResponseBody
	@SystemLog(type="del",operation="删除系统角色")
	...
	@ResponseBody
	@SystemLog(type="add",operation="创建系统角色")
	...
	@ResponseBody
	public Map<String,Object> addRole(@ModelAttribute("sysRole") SysRole sysRole,@PathVariable("type") int type){
		Map<String,Object> json = new HashMap<String,Object>();
		try{
	...
	public ModelAndView showRoleList(HttpServletRequest request){
		...
		try{
			...
			model.addObject("functionList", FastJsonUtil.obj2JsonString(functionList));
		}catch (Exception e) {
