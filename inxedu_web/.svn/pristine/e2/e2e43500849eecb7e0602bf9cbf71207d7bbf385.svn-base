...
public interface SysUserDao {
	 ...
	 */
	void updateSysUserStatus(Map<String, Object> params);
	 ...
	 * @param userLoginName
	 */
	int validateLoginName(String userLoginName);
	 ...
	 */
	void updateDisableOrstartUser(Map<String, Object> map);
	
	/***
	 * 修改用户登录最后登录时间和IP
	 * @param map
	 */
	void updateUserLoginLog(Map<String, Object> map);
}
