...
<body>
	...
	<div class="mt20">
		<div class="commonWrap">
			<a href="${ctx}/admin/website/doAddWebsiteCourse" class="layui-btn layui-btn-small" title="添加">
				添加
			</a>
						...
						<c:forEach items="${websiteCourseList}" var="websiteCourse" varStatus="index">
							<tr <c:if test="${index.count%2==1 }">class="odd"</c:if>>
								...
								<td class="c_666 czBtn" align="center">
									...
									<button type="button" class="layui-btn layui-btn-small" onclick="del(${websiteCourse.id})">删除</button>
								</td>
							</tr>
						</c:forEach>
					</c:if>
