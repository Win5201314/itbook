	...
	<div class="container">
		...
		<article class="mt30 buy-box-cx">
			...
			<div class="mt30 buy-car-box-cx">
				<header class="b-h-cx"><span class="fsize24 c-333">确认课程</span></header>
				...
				<div class="c-pay-method c-p-m">
					<div>
						...
						<div class="fr tar ddzj">
							<p class="fsize14 c-333"><span class=" hLh30">订单总价：<tt class="c-master f-fG fsize18" id="oldmoney">￥0</tt></span><span class="ml5 mr5 hLh30">-</span><span class=" hLh30">优惠金额：<tt class="c-master f-fG fsize18" id="yhmoney">￥0.00</tt></span> <span class="ml5 mr5 hLh30">=</span> <span class="c-master f-fG fsize18 hLh30" id="paySumPrice">￥0</span></p>
							<p class="fsize14 c-333 hLh30 mt10"><span>优惠类型：<tt  class="c-master" id="yhTypeId">无</tt></span></p>
							<p class="fsize18 c-333 mt20 hLh30"><span>订单支付金额：<tt class="c-master fsize34 f-fG" id="payprice">￥0</tt></span></p>
						</div>
						<div class="clear"></div>
					</div>
					<div class="tar mt40 cx-tj-btnbox">
						<a href="javascript:order(null,'COURSE')" class="order-btn">提交订单</a>
					</div>
				</div>
			</div>
