    ...
    var o = ".layui-nav", c = "layui-nav-item", r = "layui-nav-bar", u = "layui-nav-tree", d = "layui-nav-child", h = "layui-nav-more", f = "layui-anim layui-anim-upbit", y = {
        tabClick: function (i, a, s) {
            ...
            t(".layui-tab").each(function () {
                var s = t(this), o = s.children(".layui-tab-title"), c = (s.children(".layui-tab-content").children(".layui-tab-item"), 'lay-stope="tabmore"'), r = t('<span class="layui-unselect layui-tab-bar" style="z-index:1000" ' + c + " ><i " + c + ' class="layui-icon">&#xe61a;</i></span>');
            ...
            var i = t(this), a = i.parents(o),
                e = i.parent(), l = i.siblings("." + d);
            a.hasClass(u) && (l.removeClass(f),
                e["none" === l.css("display") ? "addClass" : "removeClass"](c + "ed"));
        }
    };
