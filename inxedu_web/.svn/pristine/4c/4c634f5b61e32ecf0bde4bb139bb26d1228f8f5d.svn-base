...
public interface UserAccountService {
     ...
     * @throws AccountException
     */
    boolean gainUserRechargeAmount(SysUser sysUser, Long userId, BigDecimal balance, String flag) throws AccountException, StaleObjectStateException;
    void updateUserAccount(UserAccount userAccount) throws Exception;
}