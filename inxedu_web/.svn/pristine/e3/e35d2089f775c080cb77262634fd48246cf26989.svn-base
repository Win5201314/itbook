...
<script type="text/javascript">
	var pdfUrl = '${courseKpoint.videoUrl}';
	$(function(){
		var fp = new FlexPaperViewer(	
				 'FlexPaperViewer',
				 'viewerPlaceHolder', { config : {
				 SwfFile : escape('${staticServer}'+pdfUrl),//需要使用Flexpaper打开的文档
		...
		$("#viewerPlaceHolder").css("height" , winW-148 + "px");
	});
</script>
<span id="viewerPlaceHolder" style="margin:0 auto;display:block" ></span>